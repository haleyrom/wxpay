...
func GetTradeNotificationAppId(req *http.Request, GetWxPayClient func(appid string) (*WXPay)) (wxClient *WXPay, noti *TradeNotification, err error) {
	if req == nil {
...
func (this *WXPay) AckFailNotification(w http.ResponseWriter) {
	var v = url.Values{}
	v.Set("return_code", "FAIL")
